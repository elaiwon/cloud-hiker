...
import azure from '../../../lib/core/azure';
jest.mock('../../../lib/core/azure');
  ...
  describe('CloudList(): ', () => {
    ...
    describe('execute(): ', () => {
      it('applies logic on provided inputs array.', async () => {
        ...
        const list = [
          {
            id: '/subscriptions/someSubscriptionId/resourceGroups/someResourceGroup/providers/Microsoft.Compute/virtualMachines/someName',
            name: 'someName',
            vmSize: 'Standard_B2s',
          },
        ];
        ...
        mockedAzure.getVirtualMachines.mockResolvedValue(list);
